                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text"
                                  ...
                                  data-type="seo"
                                  data-block="about"
                                  data-id="0">{{$about->seodescription_field}}</textarea>
                    </div>
                </div>
            </div>
        </div>
